...
#define SHIVA_T_SPLICE_PREPEND_SRCLINE_FUNC_ID "__shiva_splice_fn_name_prepend_srcline_"
...
#define SHIVA_T_SPLICE_FUNCTION_PREPEND_SRCLINE(fn_name, lineno)        \
        static uint64_t __shiva_splice_lineno_##fn_name __attribute__((section(".shiva.transform"))) = lineno; \
        void * __attribute__((naked)) __shiva_splice_fn_name_prepend_srcline_##fn_name(void)

...
DWARFLIB=/usr/local/lib/libdwarf.a
...
OBJ_LIST=shiva.o shiva_util.o shiva_signal.o shiva_ulexec.o shiva_auxv.o	\
    ...
    shiva_dwarf.o
STATIC_LIBS=/opt/elfmaster/lib/libelfmaster.a libcapstone_x86_64.a $(DWARFLIB) $(ELFLIB) $(LIBZ)
CC=musl-gcc -I ./
MUSL=musl-gcc -I ./
...
interp:
	...
	$(CC) $(GCC_OPTS) shiva_dwarf.c -o	shiva_dwarf.o
